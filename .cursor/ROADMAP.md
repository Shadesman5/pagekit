...
| 2.0.1  | ↳ PSR-11 Container Modernising      | ⏳     | ⏳    | -     | -       | **Current Step** |
| 2.0.2  | ↳ Validator-Translator Integration  | ⏳     | ⏳    | -     | -       | Phase 2         |
| 2.1    | Static Analysis & Code Quality      | ⏳     | ⏳    | -     | -       | Phase 2         |
| 2.1.1  | ↳ Tooling-Setup & Baseline          | ⏳     | ⏳    | -     | -       | Phase 2         |
| 2.1.2  | ↳ CI/CD Integration & Quality Gates | ⏳     | ⏳    | -     | -       | Phase 2         |
| 2.1.3  | ↳ `strict_types` Migration          | ⏳     | ⏳    | -     | -       | Phase 2         |
| 2.1.4  | ↳ PHPStan Level 5→6 (Return Types)  | ⏳     | ⏳    | -     | -       | Phase 2         |
| 2.1.5  | ↳ PHPStan Level 6→7 (Null Safety)   | ⏳     | ⏳    | -     | -       | Phase 2         |
| 2.1.6  | ↳ PHPStan Level 7→8 (Strict Typing) | ⏳     | ⏳    | -     | -       | Phase 2         |
| 2.1.7  | ↳ QueryBuilder API Standardization  | ⏳     | ⏳    | -     | -       | Phase 2         |
| 2.1.8  | ↳ Infection Mutation Testing        | ⏳     | ⏳    | -     | -       | Phase 2         |
| 2.1.9  | ↳ Test Coverage Expansion           | ⏳     | ⏳    | -     | -       | Phase 2         |
