...
/**
 * Bootstrap for PostPresenter unit tests.
 *
 ...
 * entities or the PostPresenter under test, so we require them here in
 * dependency order (traits + parents before the classes that use/extend them).
 *
