...
- Notable deviations: Plan expected tinymce advisories ~13 → ≤1 after 5.10.9;
  ...
  intent; counts recorded here for PR/Finalize.
...
- Ticket: `migration-docs/tickets/active/PROMPT_2_1_13_TinyMCE-Security-Patch_plan.md` (_TBD_ → move to `done/` after Finalize)
