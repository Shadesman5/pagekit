  ...
  <div>
    ...
    <div class="uk-margin">
      ...
      <div class="uk-form-controls">
        <input
          ...
          v-model="moduleOptions.from_address"
    ...
    <div class="uk-margin">
      ...
      <div class="uk-form-controls">
        <input
          id="form-fromname"
          v-model="moduleOptions.from_name"
          class="uk-form-width-large uk-input"
          type="text"
        />
      </div>
    ...
    <div v-show="'smtp' == moduleOptions.driver" class="uk-margin">
      ...
      <div class="uk-margin">
        ...
        <div class="uk-form-controls">
          <input
            id="form-smtpuser"
            v-model="moduleOptions.username"
            class="uk-form-width-large uk-input"
            type="text"
      ...
      <div class="uk-margin">
        ...
        <div class="uk-form-controls js-password">
          <div class="uk-form-password">
            <div class="uk-inline">
              <a
                :uk-tooltip="hidePassword ? 'Show' : 'Hide' | trans"
                delay="500"
                pos="right"
                class="uk-form-icon uk-form-icon-flip"
                href="#"
                :uk-icon="hidePassword ? 'eye-closed' : 'eye'"
                @click.prevent="hidePassword = !hidePassword"
              />
              <input
                id="form-smtppassword"
                v-model="moduleOptions.password"
      ...
      <div class="uk-margin">
        ...
        <div class="uk-form-controls">
          <select
            ...
            v-model="moduleOptions.encryption"
            class="uk-form-width-large uk-select"
          >
            <option value="">
              {{ 'None' | trans }}
    ...
    <div class="uk-margin">
      <div class="uk-form-controls">
        <button
          v-show="'smtp' == moduleOptions.driver"
          class="uk-button uk-button-default uk-text-truncate"
          type="button"
          @click="test('smtp')"
        >
...
const Mail = {
  ...
  methods: {
    test(driver) {
      ...
      this.$http
        .post(`admin/system/${driver}`, { option: this.moduleOptions })
        .then(
          function (res) {
            const { data } = res;
