<template>
    <v-modal ref="login" dialog-modifier="uk-width-medium uk-text-center" center>
        <form ref="loginForm" class="uk-panel uk-padding-small" @submit.prevent="login">
            ...
            <div class="uk-margin">
                <span class="uk-margin-small-top uk-text-meta uk-text-danger" style="letter-spacing: -1px">{{
                    'Session expired. Please log in again.' | trans
                }}</span>
            </div>
            ...
            <div class="uk-margin-medium">
                ...
                <p class="uk-margin-remove-bottom">
                    <label class="uk-text-small"
                        ><input v-model="remember" class="uk-checkbox" type="checkbox" /><span
                            class="uk-margin-small-left"
                            >{{ 'Remember Me' | trans }}</span
                        ></label
                    >
                </p>
            </div>
