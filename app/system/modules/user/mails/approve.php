                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="600" id="panel-table">
                        <tr>
                            <td valign="top" align="center" style="font-size: 16px; line-height: 24px; font-family: Helvetica, Arial, sans-serif; color: #666;">
                                ...
                                <p style="margin: 20px 0; text-align: left;"><?= __('A new user signed up for %site% with the username %username%. Please click the button below to approve the account.', ['%site%' => '<strong style="color: #444">'.$app->get('module')->get('system/site')->config('title').'</strong>', '%username%' => '<strong style="color: #444">'.$this->escape($user->username).'</strong>']) ?></p>
                                ...
                                <p style="margin: 50px 0 0 0; padding-top: 30px; border-top: 1px solid #e5e5e5; font-size: 14px; line-height: 20px; font-family: Helvetica, Arial, sans-serif; color: #999;"><a style="color: #777; text-decoration: none;" href="<?= $app->get('url')->base(0) ?>"><?= $app->get('url')->base(0) ?></a></p>
