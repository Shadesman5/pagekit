                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="600" id="panel-table">
                        <tr>
                            <td valign="top" align="center" style="font-size: 16px; line-height: 24px; font-family: Helvetica, Arial, sans-serif; color: #666;">
                                ...
                                <p style="margin: 20px 0; text-align: left;"><?= __('Thank you for signing up for %site%. Just one more step! Please click the button below to activate your account.', ['%site%' => '<strong style="color: #444">'.$app->get('module')->get('system/site')->config('title').'</strong>']) ?></p>
