        ...
        _.merge(
          {
            ...
            setup(editor) {
              editor.on('init', () => {
                ...
                const enableSctipts = vm.$parent.options
                  ? vm.$parent.options.scripts !== false
                    ? !0
                    : !1
                  : !0;

                if (enableSctipts && scripts.length) {
                  vm.loadScripts(editor, scripts, () => {
              ...
              editor.ui.registry.addToggleButton('toggletoolbar', {
                ...
                onAction(api) {
                  const toolbar2 = $(
                    '.tox-tinymce .tox-toolbar:nth-child(2)',
                ...
                onSetup(api) {
                  vm.$nextTick(() => {
                    ...
                    const toolbar1 = $(
                      '.tox-tinymce .tox-toolbar > .tox-toolbar__group:first-child',
                      editor.editorContainer
                    );
