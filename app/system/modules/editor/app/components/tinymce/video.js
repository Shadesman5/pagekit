  ...
  created() {
    ...
    tinyMCE.PluginManager.add('pagekitVideo', editor => {
        ...
        if (element.nodeName === 'IMG' && element.hasAttribute('data-mce-object')) {
          ...
          Object.keys(element.attributes).forEach(key => {
            ...
            if (
              name === 'width' ||
              name === 'height' ||
              ((name = name.match(/data-mce-p-(.*)/)) && (name = name[1]))
            ) {
              video[name] =
                element.attributes[key].nodeValue === '' || element.attributes[key].nodeValue;
            }
          });
        } else if (
      ...
      editor.ui.registry.addIcon(
        'media',
        '<svg width="24" height="24"><path d="M4 3h16c.6 0 1 .4 1 1v16c0 .6-.4 1-1 1H4a1 1 0 0 1-1-1V4c0-.6.4-1 1-1zm1 2v14h14V5H5zm4.8 2.6l5.6 4a.5.5 0 0 1 0 .8l-5.6 4A.5.5 0 0 1 9 16V8a.5.5 0 0 1 .8-.4z" fill-rule="nonzero"></path></svg>'
      );
      ...
      editor.ui.registry.addToggleButton('media', {
        ...
        onSetup(api) {
          return editor.selection.selectorChangedWithUnbind(
            'img[data-mce-object], span[data-mce-object]',
            state => {
              api.setActive(state);
              if (state) showDialog();
            }
