    ...
    <div class="uk-margin">
      ...
      <div class="uk-form-controls uk-form-controls-text">
        <p v-for="(cache, key) in caches" :key="key" class="uk-margin-small">
          <label
            ><input
              v-model="moduleConfig.caches.cache.storage"
              class="uk-radio"
              type="radio"
              :value="key"
              :disabled="!cache.supported"
            />
            {{ cache.name }}</label
          >
        </p>
    ...
    <div class="uk-margin">
      ...
      <div class="uk-form-controls uk-form-controls-text">
        <p class="uk-margin-small">
          <label
            ><input v-model="moduleConfig.nocache" class="uk-checkbox" type="checkbox" value="1" />
            {{ 'Disable cache' | trans }}</label
          >
        </p>
        <p>
      ...
      <form class="uk-form-stacked">
        ...
        <div class="uk-modal-body">
          <div class="uk-margin">
            <p class="uk-margin-small">
              <label
                ><input v-model="cache.cache" class="uk-checkbox" type="checkbox" />
                {{ 'System Cache' | trans }}</label
              >
            </p>

            <p class="uk-margin-small">
              <label
                ><input v-model="cache.temp" class="uk-checkbox" type="checkbox" />
                {{ 'Temporary Files' | trans }}</label
              >
            </p>
          </div>
        </div>
