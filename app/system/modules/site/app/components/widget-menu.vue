    ...
    <div class="pk-width-content uk-form-horizontal">
      ...
      <div class="uk-margin">
        ...
        <div class="uk-form-controls">
          <select
            id="form-level"
            v-model="widget.data.start_level"
      ...
      <div class="uk-margin">
        ...
        <div class="uk-form-controls uk-form-controls-text">
          <p class="uk-margin-small">
            <label
              ><input v-model="widget.data.mode" class="uk-radio" type="radio" value="all" />
              {{ 'Show all' | trans }}</label
            >
          </p>

          <p class="uk-margin-small">
            <label
              ><input v-model="widget.data.mode" class="uk-radio" type="radio" value="active" />
              {{ 'Show only for active item' | trans }}</label
            >
          </p>
        </div>
      </div>
