    ...
    <div class="uk-form-horizontal">
      ...
      <div class="uk-margin">
        ...
        <div class="uk-form-controls">
          <input-image v-model="config.view.logo" class-name="uk-form-width-large" />
        </div>
      </div>
      ...
      <div class="uk-margin">
        ...
        <div class="uk-form-controls">
          <input-image
            v-model="config.icons.favicon"
            :source.sync="config.icons.favicon"
      ...
      <div class="uk-margin">
        ...
        <div class="uk-form-controls">
          <input-image
            v-model="config.icons.appicon"
            :source.sync="config.icons.appicon"
            class-name="uk-form-width-large"
          />
        </div>
      </div>
