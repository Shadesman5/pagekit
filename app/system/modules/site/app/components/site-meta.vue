  ...
  <div>
    ...
    <div class="uk-form-horizontal">
      ...
      <div class="uk-margin">
        ...
        <div class="uk-form-controls">
          <input-image
            v-model="config.meta.image"
            :source.sync="config.meta.image"
      ...
      <div class="uk-margin">
        ...
        <div class="uk-form-controls">
          <input
            id="form-meta-facebook"
            v-model="config.meta.facebook"
            type="text"
      ...
      <div class="uk-margin">
        ...
        <div class="uk-form-controls">
          <input
            id="form-meta-twitter"
            v-model="config.meta.twitter"
            type="text"
            class="uk-form-width-large uk-input"
