      ...
      return {
        title: {
          ...
          caption: () => {
            ...
            return vm.node.id && trans
              ? trans('Edit %type%', { type: vm.type.label, replace: true })
              : trans('Add %type%', { type: vm.type.label, replace: true });
          }
        },
        savepage: {
          scope: 'topmenu-left',
          ...
          function (res) {
            ...
            if (!this.node.id) {
              window.history.replaceState(
                {},
                '',
                this.$url.route('admin/site/page/edit', { id: dt.node.id })
              );
            }
