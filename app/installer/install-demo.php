...
$db->insert('@system_node', ['priority' => 2, 'status' => 1, 'title' => 'About', 'slug' => 'about', 'path' => '/about', 'link' => '@page/2', 'type' => 'page', 'menu' => 'main', 'data' => "{\"defaults\":{\"id\":2}}"]);

$db->insert('@system_node', ['priority' => 4, 'status' => 1, 'title' => 'Positions', 'slug' => 'positions', 'path' => '/positions', 'link' => '@page/3', 'type' => 'page', 'menu' => 'main', 'data' => "{\"defaults\":{\"id\":3}}"]);

$db->insert('@system_node', ['priority' => 3, 'status' => 1, 'title' => 'Blog', 'slug' => 'blog', 'path' => '/blog', 'link' => '@blog', 'type' => 'blog', 'menu' => 'main']);

// Hero positions
$db->insert('@system_widget', ['title' => 'Hello, I\'m Pagekit', 'type' => 'system/text', 'status' => 1, 'nodes' => 1, 'data' => '{"content":"<h1 class=\"uk-heading-large uk-margin-large-bottom\">Hello, I\'m Pagekit,<br class=\"uk-visible@s\"> your new favorite CMS.<\/h1>\n\n<a class=\"uk-button uk-button-default uk-button-large\" href=\"http:\/\/www.pagekit.com\">Get started<\/a>"}']);

$db->insert('@system_widget', ['title' => 'About Hero', 'type' => 'system/text', 'status' => 1, 'nodes' => 2, 'data' => '{"content":"<p class=\"uk-text-uppercase\">Anna Thompson</p>\n\n<h1 class=\"uk-margin-large-bottom uk-margin-remove-top\">I\'m a freelancer in graphic<br class=\"uk-hidden-small\"> design and photography.</h1>\n\n<ul class=\"uk-grid-medium uk-flex uk-flex-center\" uk-grid>\n    <li><a href=\"#\" class=\"uk-icon-link\" uk-icon=\"pinterest\" ratio=\"2\"></a></li>\n    <li><a href=\"#\" class=\"uk-icon-link\" uk-icon=\"twitter\" ratio=\"2\"></a></li>\n    <li><a href=\"#\" class=\"uk-icon-link\" uk-icon=\"behance\" ratio=\"2\"></a></li>\n</ul>"}']);

$db->insert('@system_widget', ['title' => 'Positions Hero', 'type' => 'system/text', 'status' => 1, 'nodes' => 3, 'data' => '{"content":"<div class=\"uk-flex uk-flex-middle uk-flex-center\">\n    <span uk-icon=\"image\" ratio=\"3\" />\n</div>\n<div class=\"uk-margin\">\n    <h3><i>Some introduction content.</i></h3>\n</div>"}']);

// Modules in positions
foreach ($positions as $position) {

    for ($i = 1; $i <= 4; $i++) {
        $db->insert('@system_widget', ['title' => $position, 'type' => 'system/text', 'status' => 1, 'nodes' => 3, 'data' => '{"content":"Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus."}']);
    }
...
// Modules in sidebar
for ($i = 1; $i <= 2; $i++) {
    $db->insert('@system_widget', ['title' => 'Sidebar', 'type' => 'system/text', 'status' => 1, 'nodes' => 3, 'data' => '{"content":"Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus."}']);
}

// Footer
$db->insert('@system_widget', ['title' => 'Footer', 'type' => 'system/text', 'status' => 1, 'data' => '{"content":"<ul class=\"uk-grid-medium uk-flex uk-flex-center\" uk-grid>\n    <li><a href=\"#\" class=\"uk-icon-link\" uk-icon=\"pinterest\" ratio=\"1.5\"></a></li>\n    <li><a href=\"#\" class=\"uk-icon-link\" uk-icon=\"twitter\" ratio=\"1.5\"></a></li>\n    <li><a href=\"#\" class=\"uk-icon-link\" uk-icon=\"behance\" ratio=\"1.5\"></a></li>\n</ul>\n<ul class=\"uk-subnav uk-margin uk-flex uk-flex-center\">\n    <li><a href=\"#\">Street, Country</a></li>\n    <li><a href=\"#\">(123) 456-7899</a></li>\n    <li><a href=\"#\">email@example.com</a></li>\n</ul>\n<p class=\"uk-text-small\">Powered by <a href=\"https://pagekit.com\">Pagekit</a></p>"}']);
...
if ($db->getUtility()->tableExists('@blog_post')) {
