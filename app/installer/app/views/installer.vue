                ...
                <div class="uk-margin">
                  ...
                  >
                    ...
                    <polyline
                      ...
                      stroke-miterlimit="10"
                      points="26.071,6.5 37.601,18.03 26,29.631 "
                    />
                  </svg>
                </div>
              </a>
        ...
        <div :step="step" class="tm-slide">
          <div class="tm-container">
            <div class="uk-card uk-card-default">
              ...
              <form class="uk-card-body uk-form-horizontal tm-form-horizontal">
                ...
                <div class="uk-margin">
                  ...
                  <div class="uk-form-controls">
                    <select
                      id="form-dbdriver"
                      v-model="config.database.default"
                      class="uk-select"
                      name="dbdriver"
                    >
                ...
                <template v-if="config.database.default === 'mysql'">
                  <div class="uk-margin">
                    <label for="form-mysql-dbhost" class="uk-form-label">{{
                      'Hostname' | trans
                    }}</label>
                    <v-input
                      id="form-mysql-dbhost"
                      v-model="config.database.connections.mysql.host"
                      view="class: uk-input uk-form-width-large"
                      type="text"
                      name="host"
                      rules="required"
                  ...
                  <div class="uk-margin">
                    <label for="form-mysql-dbuser" class="uk-form-label">{{
                      'User' | trans
                    }}</label>
                    <v-input
                  ...
                  <div class="uk-margin">
                    <label for="form-mysql-dbpassword" class="uk-form-label">{{
                      'Password' | trans
                    }}</label>
                    <v-input
                      ...
                      :view="{
                        type: 'icon',
                        icon: () => (hidePassword ? 'eye-closed' : 'eye'),
                  ...
                  <div class="uk-margin">
                    <label for="form-mysql-dbname" class="uk-form-label">{{
                      'Database Name' | trans
                    }}</label>
                    <v-input
                  ...
                  <div class="uk-margin">
                    <label for="form-mysql-dbprefix" class="uk-form-label">{{
                      'Table Prefix' | trans
                    }}</label>
                    <v-input
                      ...
                      type="text"
                      name="mysqlprefix"
                      :rules="{ required: true, regex: /^[a-zA-Z][a-zA-Z0-9._\-]*$/ }"
                      message="Prefix must start with a letter and can only contain alphanumeric characters (A-Z, 0-9) and underscore (_)"
                    />
                  </div>
                </template>
                <div v-show="config.database.default == 'sqlite'" class="uk-margin">
                  <label for="form-sqlite-dbprefix" class="uk-form-label">{{
                    'Table Prefix' | trans
                  }}</label>
                  <v-input
              ...
              <buttons
                :prev="gotoStep.bind(vm, 'language')"
                :next="passes.bind(vm, stepDatabase)"
                :valid="valid"
              />
            </div>
          </div>
          ...
          <div class="tm-container">
            <div class="uk-card uk-card-default">
              ...
              <form class="uk-card-body uk-form-horizontal tm-form-horizontal">
                ...
                <div class="uk-margin">
                  <label for="form-sitename" class="uk-form-label">{{
                    'Site Title' | trans
                  }}</label>
                  <v-input
                    id="form-sitename"
                ...
                <div class="uk-margin">
                  ...
                  <v-input
                    ...
                    type="text"
                    name="user"
                    :rules="{ required: true, regex: /^[a-zA-Z0-9._\-]{3,}$/ }"
              ...
              <buttons
                :options="optionSite.bind(vm)"
                :prev="gotoStep.bind(vm, 'database')"
                :next="passes.bind(vm, stepSite)"
                :title-next="'Install'"
              ...
              <v-modal ref="optionSite" center>
                <div class="uk-modal-header">
                  <h1 class="uk-h4">
                    <span uk-icon="settings" ratio="1.1" /><span
                ...
                <div class="uk-modal-body">
                  <div class="uk-margin">
                    <label
                      ><input
                        v-model="option['demo_content']"
                        class="uk-checkbox"
                        type="checkbox"
                      />
                      {{ 'Install demo content' }}</label
                    >
                  </div>
                </div>
              ...
              <a :href="$url.route('admin')">
                ...
                >
                  <polyline
                    ...
                    stroke-linejoin="round"
                    stroke-miterlimit="10"
                    points="5.125,63.25 27.375,89.375 95.25,18.875"
                  />
                </svg>
              </a>
            </div>
...
const Installer = {
  ...
  created() {
    ...
    _.forEach(this.config.database.connections, connection => {
      _.extend(connection, { prefix: 'pk_' });
    });
  ...
  methods: {
    ...
    stepLanguage() {
      ...
      if (this.removeLocaleScript()) {
        this.$http
          .get('/api/system/intl/locales', { params: { locale: this.locale } })
          .then(res => {
