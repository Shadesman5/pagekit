    ...
    <div class="pk-width-content">
      <div class="uk-margin">
        ...
        <v-input
          ...
          view="class: uk-form-large uk-width-1-1 uk-input"
          rules="required"
      ...
      <div class="uk-margin">
        ...
        <div class="uk-form-controls">
          <v-editor
            ...
            :options="{ markdown: post.data.markdown }"
          />
        </div>
      </div>
      <div class="uk-margin">
        ...
        <div class="uk-margin">
          ...
          <div class="uk-form-controls uk-form-controls-text">
            ...
            <p class="uk-margin-small">
              <label
                ><input
                  v-model="post.comment_status"
                  class="uk-checkbox"
                  type="checkbox"
                  value="1"
                />
                {{ 'Enable Comments' | trans }}</label
              >
            </p>
          </div>
        </div>
