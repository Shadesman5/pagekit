<template>
  <div class="uk-form-horizontal">
    ...
    <template v-if="node.type === 'page'">
      <div class="uk-margin-small">
        ...
        <div class="uk-form-controls uk-form-controls-text">
          <label
            ><input v-model="theme.title_hide" class="uk-checkbox" type="checkbox" />
            {{ 'Hide Title' | trans }}</label
          >
        </div>
      </div>
      ...
      <div class="uk-margin-small">
        ...
        <div class="uk-form-controls uk-form-controls-text">
          <label
            ><input v-model="theme.title_large" class="uk-checkbox" type="checkbox" />
            {{ 'Extra large title.' | trans }}</label
          >
        </div>
      </div>
      ...
      <div class="uk-margin-small">
        ...
        <div class="uk-form-controls uk-form-controls-text">
          <label
            ><input v-model="theme.alignment" class="uk-checkbox" type="checkbox" />
            {{ 'Center the title and content.' | trans }}</label
          >
        </div>
      </div>
      ...
      <div class="uk-margin-small">
        ...
        <div class="uk-form-controls uk-form-controls-text">
          <label
            ><input v-model="theme.content_hide" class="uk-checkbox" type="checkbox" />
            {{ 'Hide content.' | trans }}</label
          >
        </div>
      </div>
    </template>
    ...
    <div v-if="!theme.content_hide" class="uk-margin-small">
      ...
      <div class="uk-form-controls uk-form-controls-text">
        <label
          ><input v-model="theme.sidebar_first" class="uk-checkbox" type="checkbox" />
          {{ 'Show the sidebar before the content.' | trans }}</label
        >
      </div>
    </div>
    ...
    <div class="uk-margin-small">
      <div v-for="name in visiblePositions" :key="name" class="uk-margin-small">
        ...
        <label class="uk-form-label uk-text-capitalize"
          >{{ name === 'main' ? 'Main' : configPositions[name] }} {{ 'Position' | trans }}</label
        >
        <div class="uk-form-controls uk-form-controls-text">
          <div class="uk-child-width-1-2@m uk-grid-small uk-height-match" uk-grid>
            <div>
              ...
              <div
                v-if="positions[name]['image']"
                class="uk-margin-small-top uk-form-width-large uk-responsive-width"
              >
            ...
            <div>
              <div class="uk-margin-small uk-form-width-large uk-responsive-width">
                ...
                <div
                  v-if="positions[name]['size'] !== 'uk-padding-remove-vertical'"
                  class="uk-margin-small"
                >
                  <div class="uk-text-small">
                    <label :class="{ 'uk-text-meta': !positions[name]['padding_remove_top'] }"
                      ><input
                        v-model="positions[name]['padding_remove_top']"
                        class="uk-checkbox"
                        type="checkbox"
                      />
                      {{ 'Remove section top padding.' | trans }}</label
                    >
                  </div>
                  <div class="uk-text-small">
                    <label :class="{ 'uk-text-meta': !positions[name]['padding_remove_bottom'] }"
                      ><input
                        v-model="positions[name]['padding_remove_bottom']"
                        class="uk-checkbox"
                        type="checkbox"
                      />
                      {{ 'Remove section bottom padding.' | trans }}</label
                    >
                  </div>
                </div>
                <div class="uk-text-meta">
              ...
              <div class="uk-margin-small">
                <select
                  v-model="positions[name]['vertical_align']"
              ...
              <div class="uk-margin-small-top">
                <div class="uk-text-small">
                  <label :class="{ 'uk-text-meta': !positions[name]['header_transparent'] }"
                    ><input
                      v-model="positions[name]['header_transparent']"
                      class="uk-checkbox"
                      type="checkbox"
                    />
                    {{ 'Transparent header.' | trans }}</label
                  >
                </div>
                <div v-if="positions[name]['header_transparent']" class="uk-text-small">
                  <label :class="{ 'uk-text-meta': !positions[name]['header_preserve_color'] }"
                    ><input
                      v-model="positions[name]['header_preserve_color']"
                      class="uk-checkbox"
                      type="checkbox"
                    />
                    {{ 'Preserve header colors.' | trans }}</label
                  >
                </div>
                <div v-if="positions[name]['header_transparent']" class="uk-text-small">
                  <label
                    :class="{
                      'uk-text-meta': !positions[name]['header_transparent_noplaceholder']
                    }"
                    ><input
                      v-model="positions[name]['header_transparent_noplaceholder']"
                      class="uk-checkbox"
                      type="checkbox"
                    />
                    {{ 'Pull content beneath navbar.' | trans }}</label
                  >
                </div>
                <div
                  v-if="
                    positions[name]['style'] === 'uk-section-primary' ||
                    positions[name]['style'] === 'uk-section-secondary'
                  "
                  class="uk-text-small"
                >
                  <label :class="{ 'uk-text-meta': !positions[name]['preserve_color'] }"
                    ><input
                      v-model="positions[name]['preserve_color']"
                      type="checkbox"
                      class="uk-checkbox"
                    />
                    {{ 'Preserve section colors.' | trans }}</label
                  >
                </div>
                <div class="uk-text-small">
                  <label :class="{ 'uk-text-meta': !positions[name]['overlap'] }"
                    ><input
                      v-model="positions[name]['overlap']"
                      type="checkbox"
                      class="uk-checkbox"
                    />
                    {{
                      'Apply a border image and a negative offset to the section.' | trans
                    }}</label
                  >
                </div>
              </div>
