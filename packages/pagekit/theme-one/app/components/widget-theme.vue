  ...
  <div class="uk-form-horizontal">
    <div class="uk-margin">
      ...
      <div class="uk-form-controls uk-form-controls-text">
        <label
          ><input v-model="options.title_hide" class="uk-checkbox" type="checkbox" />
    ...
    <div class="uk-margin">
      ...
      <div class="uk-form-controls">
        <select
          id="form-theme-title-size"
          v-model="options.title_size"
    ...
    <div class="uk-margin">
      ...
      <div class="uk-form-controls uk-form-controls-text">
        <label
          ><input v-model="options.alignment" class="uk-checkbox" type="checkbox" />
...
const WidgetTheme = {
  ...
  created() {
    ...
    if (
      !this.widget.theme.title_size ||
      !_.filter(this.heading, (title, value) => value === this.widget.theme.title_size).length
    ) {
