    ...
    <div class="uk-form uk-form-horizontal">
      <div class="uk-margin-small">
        ...
        <div class="uk-form-controls uk-form-controls-text">
          <div class="uk-text-small uk-margin-small">
            <label
              ><input v-model="config.header.fullwidth" type="checkbox" class="uk-checkbox" />
              {{ 'Expand header container width.' | trans }}</label
            >
          </div>
          <div v-if="config.header.fullwidth" class="uk-text-small uk-margin-small">
            <label
              ><input
                v-model="config.header.logo_padding_remove"
                type="checkbox"
                class="uk-checkbox"
              />
              {{ 'Remove logo padding.' | trans }}</label
            >
          </div>
        </div>
      </div>
      ...
      <div class="uk-margin-small">
        ...
        <div class="uk-form-controls">
          <select v-model="config.navbar.sticky" class="uk-select uk-form-width-large">
            ...
            <option value="2">Sticky on scroll up</option>
          </select>
          <div class="uk-text-meta uk-form-width-large">
      ...
      <div class="uk-margin-small">
        ...
        <div class="uk-form-controls uk-form-controls-text">
          ...
          <div class="uk-text-small uk-margin-small">
            <label
              ><input
                v-model="config.navbar.dropdown_boundary"
                type="checkbox"
                class="uk-checkbox"
              />
              {{ 'Align to navbar instead of the menu item' | trans }}</label
            >
          </div>
        </div>
      </div>
      ...
      <div class="uk-margin-small">
        ...
        <div class="uk-form-controls uk-form-controls-text">
          ...
          <div class="uk-text-meta uk-form-width-large">
            {{
              'Extends to the full width of the navbar and displays the dropdown without its default styling.'
                | trans
            }}
          </div>
        </div>
      ...
      <div class="uk-margin-small">
        ...
        <div class="uk-form-controls uk-form-controls-text">
          ...
          <div class="uk-text-small uk-margin-small">
            <label
              ><input
                v-model="config.navbar.offcanvas.overlay"
                type="checkbox"
                class="uk-checkbox"
              />
              {{ 'Add an overlay, blanking out the page.' | trans }}</label
            >
          </div>
          <div class="uk-text-small uk-margin-small">
            <label
              ><input v-model="config.navbar.offcanvas.flip" type="checkbox" class="uk-checkbox" />
              {{ 'Slides off-canvas from the right.' | trans }}</label
            >
          </div>
          <div class="uk-text-meta uk-form-width-large">
...
const SiteTheme = {
  ...
  events: {
    'settings-save': function () {
      this.$http
        .post('admin/system/settings/config', { name: this.name, config: this.config })
        .catch(function (res) {
