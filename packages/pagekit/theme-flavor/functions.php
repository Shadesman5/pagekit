...
final class ThemeFlavorHelpers
{
    ...
    {
        if (self::$url === null) {
            throw new \RuntimeException('ThemeFlavorHelpers::setUrl() must be called before using template helpers.');
        }
        return self::$url;
    }
}
...
{
    $path = ThemeFlavorHelpers::getUrl()->get($url);
