...
return [
    ...
    */
    ...
    //         ],
    //         'config' => 'hello:views/widget-edit.php', // optionales Backend-Formular
    //         'view' => 'hello:views/widget.php'        // HTML-Ausgabe
    //     ]
    // ],
    ...
    'events' => [
        'view.scripts' => function ($event, $scripts) {
            ...
            $scripts->register('hello-widget', 'hello:app/bundle/widget.js', 'widget');
        }
    ]
